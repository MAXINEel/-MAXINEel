...
local RunBot = io.open("MAXINEel", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/MAXINEel
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr MAXINEel.lua
wget "https://raw.githubusercontent.com/MAXINEel/MAXINEel/main/MAXINEel.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./MAXINEel.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S MAXINEel -X kill
screen -S MAXINEel ./MAXINEel
done
]])
RunTs:close()
end
